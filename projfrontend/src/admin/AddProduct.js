 ...
 useEffect(()=>{
  ...
  const onSubmit = event =>{
    ...
    .then(data=>{
      ...
      price:"",photo:"",stock:"",loading:false,createdProduct:data.name
      });
      }
    })
  ...
  //     <h4>failed to  create  for {createdProduct} successfully</h4>
  //   </div>
  // }
  ...
  return(
  <Base title="Add a Product" description="Welcome to prodcut creation section" 
